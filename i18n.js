  ...
  var PACK = {
    tr: {
      ...
      gate: {
        ...
        lead: "Size verilen kullanıcı adını yazın. İlk girişte kendi şifrenizi oluşturursunuz (eski ortak kod geçerli değildir).",
    ...
    en: {
      ...
      gate: {
        ...
        lead: "Enter the username you were given. On first login you create your own password (the old shared code no longer works).",
