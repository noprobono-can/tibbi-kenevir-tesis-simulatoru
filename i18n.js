(function () {
  ...
  var PACK = {
    tr: {
      ...
      market: {
        loading: "Cannastream: yükleniyor…",
        error: "Cannastream: bağlantı yok",
        live: "Cannastream · canlı",
    ...
    en: {
      ...
      market: {
        loading: "Cannastream: loading…",
        error: "Cannastream: offline",
        live: "Cannastream · live",
