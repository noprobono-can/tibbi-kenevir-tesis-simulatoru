  ...
  var PACK = {
    tr: {
      ...
      dom: {
        ...
        "gate.lead": "Size verilen kullanıcı adını yazın. İlk girişte kendi şifrenizi oluşturursunuz.",
        "gate.privacy": "Kişisel verileriniz saklanmaz. Kullanım sırasında bilgisayarınızdan veya telefonunuzdan hiçbir kişisel bilgi kullanılmaz.",
      ...
      gate: {
        title: "Tıbbi kenevir simülatörü",
        titleLogin: "Giriş",
        titleSetup: "Şifre oluştur",
        lead: "Size verilen kullanıcı adını yazın. İlk girişte kendi şifrenizi oluşturursunuz.",
        leadLogin: "Devam etmek için şifrenizi girin.",
        leadSetup: "İlk girişiniz için kendi şifrenizi belirleyin (en az 8 karakter). Şifre yalnızca bu tarayıcıda saklanır.",
        privacy: "Kişisel verileriniz saklanmaz. Kullanım sırasında bilgisayarınızdan veya telefonunuzdan hiçbir kişisel bilgi kullanılmaz.",
        userLabel: "Kullanıcı adı",
        passLabel: "Şifre",
        confirmLabel: "Şifre tekrar",
        continue: "Devam et",
        submit: "Giriş yap",
        createPass: "Şifre oluştur",
        back: "Kullanıcı adını değiştir",
        session: "Davetli oturum",
        noUsers: "gate-config.js içinde users tanımlayın.",
        unknownUser: "Bu kullanıcı adı tanınmıyor. Yalnızca kayıtlı hesaplar giriş yapabilir.",
        badLogin: "Kullanıcı adı veya şifre hatalı.",
        passMismatch: "Şifreler eşleşmiyor.",
        alreadyHasPass: "Bu hesap için şifre zaten var. Giriş adımına geçildi.",
        setupFail: "Şifre oluşturulamadı. Tekrar deneyin.",
        authMissing: "Kimlik doğrulama modülü yüklenemedi.",
        changeCurrent: "Mevcut şifreniz:",
        changeNew: "Yeni şifre (en az {n} karakter):",
        changeConfirm: "Yeni şifre tekrar:",
        changeOk: "Şifre güncellendi.",
        changeFail: "Mevcut şifre hatalı."
      },
      ...
      market: {
        ...
        generalBadge: "GENEL",
        generalOutlook: "SERBEST SİMÜLASYON",
        generalNotes: "Ülkeden bağımsız mod. Cannastream pazar verisi uygulanmaz; kapasite, proses ve fiyatları istediğiniz gibi ayarlayabilirsiniz.",
        generalHint: "Belirli bir ülke seçerseniz pazar bağlamı ve otomatik tesis önerisi açılır.",
        generalSide: "Genel mod · market verisi kapalı",
        generalSync: "Genel mod · serbest parametreler",
        noDataBadge: "VERİ YOK",
        noDataNotes: "Bu pazar için Cannastream fiyat / talep verisi yok. Önceki ülkenin verileri temizlendi; parametreleri serbestçe ayarlayabilirsiniz.",
        noDataHint: "Verisi olan bir ülke seçerek pazar bağlamını yeniden açabilirsiniz.",
        noDataSide: "Pazar verisi yok · önceki bağlam temizlendi",
        noDataSync: "Pazar verisi yok",
        patients: "Hasta",
        market: "Pazar",
        growth: "Büyüme",
        authority: "Otorite",
    ...
    en: {
      ...
      dom: {
        ...
        "gate.lead": "Enter the username you were given. On first login you create your own password.",
        "gate.privacy": "No personal data is stored. During use, no personal information from your computer or phone is accessed.",
      ...
      gate: {
        title: "Medical cannabis simulator",
        titleLogin: "Sign in",
        titleSetup: "Create password",
        lead: "Enter the username you were given. On first login you create your own password.",
        leadLogin: "Enter your password to continue.",
        leadSetup: "Set your own password for first login (min 8 characters). It is stored only in this browser.",
        privacy: "No personal data is stored. During use, no personal information from your computer or phone is accessed.",
        userLabel: "Username",
        passLabel: "Password",
        ...
        back: "Change username",
        session: "Guest session",
        noUsers: "Define users in gate-config.js.",
        unknownUser: "Unknown username. Only registered accounts can sign in.",
        badLogin: "Invalid username or password.",
        passMismatch: "Passwords do not match.",
        alreadyHasPass: "This account already has a password. Switched to sign-in.",
        setupFail: "Could not create password. Try again.",
        authMissing: "Auth module failed to load.",
        changeCurrent: "Current password:",
        changeNew: "New password (min {n} characters):",
        changeConfirm: "Confirm new password:",
        changeOk: "Password updated.",
      ...
      market: {
        ...
        generalOutlook: "FREE SIMULATION",
        generalNotes: "Country-independent mode. Cannastream market data is not applied; adjust capacity, process and prices freely.",
        generalHint: "Pick a specific country to enable market context and auto facility suggestions.",
        generalSide: "General mode · market data off",
        generalSync: "General mode · free parameters",
        noDataBadge: "NO DATA",
        noDataNotes: "No Cannastream price / demand data for this market. Previous country data was cleared; adjust parameters freely.",
        noDataHint: "Select a country with data to reopen market context.",
        noDataSide: "No market data · previous context cleared",
        noDataSync: "No market data",
        patients: "Patients",
        market: "Market",
        growth: "Growth",
        authority: "Authority",
