  ...
  var PACK = {
    tr: {
      ...
      gate: {
        ...
        lead: "Devam etmek için kullanıcı adınızı girin. İlk girişte kendi şifrenizi oluşturursunuz.",
        leadLogin: "Devam etmek için şifrenizi girin.",
        leadSetup: "İlk girişiniz için kendi şifrenizi belirleyin. Şifre yalnızca bu tarayıcıda saklanır.",
    ...
    en: {
      ...
      gate: {
        ...
        lead: "Enter your username to continue. On first login you create your own password.",
        leadLogin: "Enter your password to continue.",
        leadSetup: "Set your own password for first login. It is stored only in this browser.",
        userLabel: "Username",
        passLabel: "Password",
